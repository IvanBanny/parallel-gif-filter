...
static void apply_blur_filter_stripe(local_stripe* stripe, int size, int threshold, int frame_rank, int frame_size, MPI_Comm frame_comm)
{
    ...
    pixel* new_pixels = malloc_bytes((size_t)total_rows * (size_t)width * sizeof(pixel), "stripe blur pixels");
...
static void apply_sobel_filter_stripe(local_stripe *stripe, int frame_rank, int frame_size, MPI_Comm frame_comm) 
{
    ...
    pixel* sobel = malloc_bytes((size_t)total_rows * (size_t)width * sizeof(pixel), "stripe sobel pixels");
...
{
    int* frame_group_size = malloc_bytes((size_t)n_images * sizeof(int), "frame group size");
    int* rank_to_frame = malloc_bytes((size_t)n_ranks * sizeof(int), "rank to frame");
    int* rank_in_group = malloc_bytes((size_t)n_ranks * sizeof(int), "rank in group");
